...
import {
  ...
  validateSerie,
  validateDescricao,
} from "../../validations/validaDadosAddSerie";
  ...
  const verificaPreenchimentoCampos = (name) => {
    if (name == "serie") {
      if (formData.serie.trim() === "") {
        setErros({
          ...erros,
          serie: { temErros: true, mensagem: "Campo obrigatório." },
        });
        ...
        setErros({
          ...
          serie: {
            temErros: true,
            mensagem:
              'O campo precisa ser preenchido da seguinte forma = "1° ano do fundamental" ano + grau, e ter no mínimo 5 caracters',
          },
        });
      } else {
      ...
      if (formData.descricao.trim() == "") {
        setErros({
          ...erros,
          descricao: { temErros: true, mensagem: "Campo obrigatório." },
        });
        ...
        setErros({
          ...
          descricao: {
            temErros: true,
            mensagem: "Descrição deve ter no mínimo 250 caracteres.",
          },
        });
      } else {
      ...
      if (selectedOption === "") {
        setErros({
          ...erros,
          selecao: { temErros: true, mensagem: "Campo obrigatório." },
        });
        ...
        setErros({
          ...
          selecao: {
            temErros: true,
            mensagem: "Por favor, selecione uma opção antes de prosseguir.",
          },
        });
      } else {
  ...
  return (
    <FormEditarInfos>
      ...
      <form>
        ...
        />
        {erros.serie.temErros && (
          <DescricaoDadoIncorreto>
            {erros.serie.mensagem}
          </DescricaoDadoIncorreto>
        )}
        ...
        <Input
          ...
          onBlur={(e) => verificaPreenchimentoCampos(e.target.name)}
        />
        {erros.descricao.temErros && (
          <DescricaoDadoIncorreto>
            {erros.descricao.mensagem}
          </DescricaoDadoIncorreto>
        )}
        ...
        {erros.selecao.temErros && (
          <DescricaoDadoIncorreto>
            {erros.selecao.mensagem}
          </DescricaoDadoIncorreto>
        )}
        <DescricaoSobInput>
          Fotos / Descrição da Infraestrutura
        </DescricaoSobInput>
